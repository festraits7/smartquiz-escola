...
# CORREÇÃO DA LEITURA DO WORD: Captura linhas estruturadas e ignora vazios
def carregar_perguntas():
    nome_arquivo = "perguntas.docx"
    ...
    for paragrafo in doc.paragraphs:
        ...
        if texto and " - " in texto:
            ...
            if len(partes) >= 3:
                ...
                # Sincronização e embaralhamento controlado
...
# Inicialização limpa dos estados do terminal
